...
📂 Project Structure
├── app.py ├── documentloader.py ├── chunking.py ├── embedding.py ├── vectorstorage.py ├── retrieval.py ├── classifier.py ├── llm_engine.py ├── response_parser.py ├── test.py ├── .env └── requirements.txt
